    ...
    <div className="min-h-[70vh] flex items-center justify-center px-4">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-lg border border-gray-200 p-8">
        ...
        <p className="text-gray-600 text-center text-sm mb-6">
          {t("nav.register")} / Giriş için aynı butonu kullanın.
        </p>
        {error && (
        ...
        <button
          ...
          disabled={signingIn}
          className="w-full flex items-center justify-center gap-2 px-4 py-3 border border-gray-300 rounded-xl hover:bg-gray-50 font-medium text-gray-700 disabled:opacity-50"
        >
          ...
          {signingIn ? "…" : "Google ile giriş yap"}
        </button>
